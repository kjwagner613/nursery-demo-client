...
const Products = () => {
  ...
  // Reset to first product when search term changes
  useEffect(() => {
          ...
          >
            {filteredProducts.length > 0 && (
              <>
                ...
                <p>
                  Category: {filteredProducts[currentProductIndex].category} / {filteredProducts[currentProductIndex].subcategory}
                </p>
                ...
                <p>
                  Total Price: ${(filteredProducts[currentProductIndex].price * selectedQty).toFixed(2)}
                </p>
